chebyshev.t.quadrature <- function( functn, rule, lower=-1, upper=1, weighted=TRUE, ... )
{
###
...
###	Chebyshev polynomial of the first kind, T_n(x), weight function and interval [-1,1]
